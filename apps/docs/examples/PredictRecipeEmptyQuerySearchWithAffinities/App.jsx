...
const userID = "f177768717.443450946";
...
function PersonalizedProducts() {
  ...
  // Get the top affinities with probabilities greater than 50%
  const topAffinities = affinities.filter(
    (affinity) => affinity.probability > 0.5
  );
  ...
  return (
    <div className="p-2">
      <InstantSearch searchClient={searchClient} indexName={indexName}>
        ...
        <Configure
          hitsPerPage={12}
          // Pass top affinities as optionalFilters to search using Configure component
