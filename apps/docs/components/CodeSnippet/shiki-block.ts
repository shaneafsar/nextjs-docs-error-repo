// https://github.com/withastro/docs/blob/main/src/components/CodeSnippet/shiki-block.ts
...
export class ShikiBlock {
  ...
  renderToHtml() {
    const MIN_LINES_TO_RENDER_NUMBER = 20;

    const linesHtml = this.shikiLines
      .map((line) => {
        if (this.shikiLines.length <= MIN_LINES_TO_RENDER_NUMBER) {
          line.addClass("no-line-number");
        }
